package gg.hazard.spotify.utils.menu;
...
public abstract class Menu {
    ...
    private Inventory createInventory(Player player) {
        ...
        final Inventory inventory = hHub.getInstance().getServer().createInventory(player, size(player), getTitle(player));
    ...
    private static Method getOpenInventoryMethod() {
        if (openInventoryMethod == null) {
            try {
                ...
                Bukkit.getLogger().log(Level.SEVERE, "Failed to get openCustomInventory method from CraftHumanEntity", var1);
            }
        }
    ...
    public void openMenu(Player player) {
        ...
        try {
            ...
            Bukkit.getLogger().log(Level.SEVERE, "Failed to open menu for player", var5);
        }
    ...
    private void update(Player player) {
        ...
        runnable.runTaskTimer(hHub.getInstance(), 10L, 10L);

package gg.hazard.spotify.extra.nametags.impl;

import gg.hazard.spotify.extra.nametags.impl.packet.ScoreboardTeamPacketMod;
import gg.hazard.spotify.hHub;
import lombok.Getter;
import lombok.Setter;
import org.bukkit.Bukkit;
import org.bukkit.entity.Player;
import gg.hazard.spotify.extra.nametags.impl.construct.NameTagComparator;
import gg.hazard.spotify.extra.nametags.impl.construct.NameTagInfo;
import gg.hazard.spotify.extra.nametags.impl.construct.NameTagUpdate;
import gg.hazard.spotify.extra.nametags.impl.listener.NameTagListener;
...
public class NameTagHandler {
    ...
    public NameTagHandler(hHub plugin) {
        this.plugin = plugin;
        this.initiated = true;
    ...
    public void reloadPlayerInternal(Player toRefresh, Player refreshFor) {
        if (!refreshFor.hasMetadata("spotify-LoggedIn")) return;

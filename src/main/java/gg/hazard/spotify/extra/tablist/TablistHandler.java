...
import gg.hazard.spotify.extra.tablist.adapter.TabAdapter;
import gg.hazard.spotify.extra.tablist.adapter.impl.HubTablistAdapter;
import gg.hazard.spotify.extra.tablist.listener.TabListener;
import gg.hazard.spotify.extra.tablist.listener.TeamsPacketListener;
import gg.hazard.spotify.extra.tablist.setup.TabLayout;
import gg.hazard.spotify.extra.tablist.thread.TablistThread;
...
public class TablistHandler {
    ...
    public void init(PacketEventsAPI<?> packetEventsAPI) {
        ...
        this.adapter = new HubTablistAdapter();
    ...
    public void registerAdapter(TabAdapter tabAdapter, long ticks) {
        ...
        this.adapter = tabAdapter == null ? new HubTablistAdapter() : tabAdapter;
        this.ticks = ticks;
